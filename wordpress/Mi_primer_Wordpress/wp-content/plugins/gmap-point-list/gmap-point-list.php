...
function wpg_post_type() {
	...
	'menu_position' => 30,
	'public' => true,
	'menu_icon' => $dir . 'images/marker.png',
	'query_var' => true,
...
function register_my_script() {
    ...
    wp_register_script('markermanager', $dir  . 'js/markermanager.js', array('jquery'), '1.0', true);
    wp_register_script('StyledMarker', $dir  . 'js/StyledMarker.js', array('jquery'), '1.0', true);
    wp_register_script('metadata', $dir  . 'js/jquery.metadata.js', array('jquery'), '1.0', true);
    wp_register_script('jmapping', $dir  . 'js/jquery.jmapping.min.js', array('jquery'), '1.0', true);
}
...
function print_my_script() {
	...
	wp_print_scripts('markermanager');
	wp_print_scripts('StyledMarker');
	wp_print_scripts('metadata');
	wp_print_scripts('jmapping');
}
...
function gmap_page_settings() {
    ...
    <form method="post" action="">
        ...
        <p><strong><?php echo __('New function: Map Type.','wpg'); ?></strong> <?php echo __('You can select the type of map. The available options are ROADMAP (default), SATELLITE, HYBRID or TERRAIN. This parameter is optional.','wpg'); ?></p>
        ...
        <table id="featured-posts-list" class="wp-list-table widefat">
			...
			foreach ($front_page_elements as $element) : ?>
                <tr class="front-page-element" id="front-page-element-<?php echo $element_counter; ?>">
                    ...
                    <td><span>[gmaplist map="<?php echo $element; ?>" type="ROADMAP"]</span>  </td>
                    <td><span>[gmapwidget map="<?php echo $element; ?>" type="ROADMAP"]</span>  </td>
	...
	<div id="gmapWidget">
	 ...
	 while ( $query->have_posts() ) :
		...
		?>
        	...
        	<dt>
            	<img src="<?php echo $dir; ?>images/mappointer.png" width="24" height="25" alt="<?php the_title(); ?>" />
            </dt>
            <dd>
            	<address>
