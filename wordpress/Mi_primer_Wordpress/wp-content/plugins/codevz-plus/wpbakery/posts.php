			...
			'params'		=> array(
				...
				array(
					...
					'value'			=> array(
						...
						esc_html__( 'Icon and Title on hover', 'codevz' ) 							=> 'cz_grid_1_no_desc',
						esc_html__( 'Icon, Title and Meta on hover', 'codevz' ) 						=> 'cz_grid_1_yes_all',
						esc_html__( 'Title on hover', 'codevz' ) 									=> 'cz_grid_1_no_icon cz_grid_1_no_desc',
						esc_html__( 'Title and Meta on hover', 'codevz' ) 							=> 'cz_grid_1_no_icon',
						esc_html__( 'Title and Excerpt on hover', 'codevz' ) 							=> 'cz_grid_1_no_icon cz_grid_1_has_excerpt cz_grid_1_no_desc',
						esc_html__( 'Title, Meta and Excerpt on hover', 'codevz' ) 					=> 'cz_grid_1_no_icon cz_grid_1_has_excerpt',
						esc_html__( 'No hover details, Title and Meta after Image', 'codevz' ) 		=> 'cz_grid_1_title_sub_after cz_grid_1_no_hover',
						esc_html__( 'Icon on hover, Title and Meta after Image', 'codevz' ) 			=> 'cz_grid_1_title_sub_after',
						esc_html__( 'Icon on hover, Title, Meta and Excerpt after Image', 'codevz' ) => 'cz_grid_1_title_sub_after cz_grid_1_has_excerpt',
						esc_html__( 'No Icon, Title, Meta and Excerpt after Image', 'codevz' ) 		=> 'cz_grid_1_title_sub_after cz_grid_1_has_excerpt cz_grid_1_no_icon',
						esc_html__( 'Meta on image, Title after image', 'codevz' ) 					=> 'cz_grid_1_title_sub_after cz_grid_1_subtitle_on_img',
						esc_html__( 'Meta on image, Title and Excerpt after image', 'codevz' ) 		=> 'cz_grid_1_title_sub_after cz_grid_1_has_excerpt cz_grid_1_subtitle_on_img',
						esc_html__( 'No image, Title and Meta', 'codevz' ) 							=> 'cz_grid_1_title_sub_after cz_grid_1_no_image',
						esc_html__( 'No image, Title, Meta and Excerpt', 'codevz' ) 					=> 'cz_grid_1_title_sub_after cz_grid_1_has_excerpt cz_grid_1_no_image',
					),
					...
					'params' 		=> array(
						array(
							...
							'value'				=> array(
								...
								esc_html__( 'Avatar, Author and Date', 'codevz' ) => 'author_full_date',
								esc_html__( 'Icon, Author and Date', 'codevz' ) 	=> 'author_icon_date',
				...
				array(
					"type"        	=> "checkbox",
					"heading"     	=> esc_html__("Smart details?", 'codevz'),
				...
				array(
					"type"        	=> "dropdown",
					"heading"     	=> esc_html__("Size and Position", 'codevz'),
	...
	public static function get_posts( $atts = '', $out = '' ) {
		...
		if ( $query->have_posts() ) {
			...
			while ( $query->have_posts() ) {
				...
				$out .= '<a class="cz_grid_link' . $img_fx . $issvg . '" href="' . get_the_permalink() . '" title="' . get_the_title() . '"' . $atts['tilt_data'] . '>';
