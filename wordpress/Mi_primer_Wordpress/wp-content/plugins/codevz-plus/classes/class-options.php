...
class Codevz_Options {
	...
	public static function css_out( $is_customize_preview = 0, $single_page = 0, $post_id = '' ) {
		...
		if ( function_exists( 'is_woocommerce' ) && ! Codevz_Plus::option( 'woo_disable_sold_out' ) ) {
			$out .= '.outofstock img {filter: grayscale(100%)}';
		}
		...
		if ( $i ) {
			...
			return array(
				...
				array(
					...
					'dependency'  	=> array( 'page_cover|page_title', 'any|any', 'title|8' )
				),
				array(
					...
					array(
						...
						'fields' => wp_parse_args(
							array(
								...
								array(
									'id'    		=> 'woo_disable_sold_out',
									'type'  		=> 'switcher',
									'title' 		=> esc_html__( 'Disable sold out badge', 'codevz' )
								),
								array(
									'id'    		=> 'woo_show_zero_count',
									'type'  		=> 'switcher',
									'title' 		=> esc_html__( 'Show cart zero', 'codevz' ),
								),
								array(
									'id'    		=> 'woo_cart',
									'type'  		=> 'text',
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'setting_args' 	=> [ 'transport' => 'postMessage' ],
								'settings' 		=> array( 'color', 'font-size', 'font-style' ),
								'selector' 		=> '.woocommerce .woocommerce-error, .woocommerce .woocommerce-info, .woocommerce .woocommerce-message'
							),
							array(
